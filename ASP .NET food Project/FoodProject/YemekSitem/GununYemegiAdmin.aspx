<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="GununYemegiAdmin.aspx.cs" Inherits="YemekSitem.GununYemegiAdmin" %>
            ...
            <ItemTemplate>
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style11"><a href="YemekDuzenle.aspx?YemekId=<%#Eval("YemekId")%>">
                            <asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/ikonlar/choose.png" Width="30px" />
                            </a></td>
                    </tr>
                </table>
            </ItemTemplate>
